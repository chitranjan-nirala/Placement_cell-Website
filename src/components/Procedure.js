  ...
  <div className="procedure-outer">
    <div className="procedure-wrapper">
      ...
      <ul className="custom-list">
        <li>
        The Placement Office initiates the recruitment procedure by sending invitations to reputed companies.
The placement website (www.tigplacement.com) provides comprehensive information about the latest campus-related 
activities at Techno India Group.
        </li>
        <li>
          ...
          sent by email to Training and Placement Office,TIU West Bengal (
          <a href="mailto:tigplacementdesk@gmail.com">tigplacementdesk@gmail.com</a>
          ).
        </li>
        <li>
        ...
        <li>
          Training and Placement Office, TIU allots date(s) to an organization
          for campus placements. The organization confirms the date(s) to
          Training and Placement Office, TIU.
        </li>
        <li>
        ...
        <li>
          Training and Placement Office,TIU also coordinates the signing of
      ...
      <div className="sub-part">
        ...
        <h2>Internship</h2>
        <p>
          B. Tech 3rd year students are eligible for <strong>3 months</strong>{" "}
          summer internship The student will join the company in May/June 2024
          as an intern for a period of 3 months.
        </p>
        <p>
      ...
      <div className="placement-policy-heading">
        ...
        <ul className="custom-list">
          ...
          <li>
            ...
            gets an offer from Dream round company.
          </li>
          <li>
