...
const Facilities = props => (
  <div className="procedure-outer">
    <div className="procedure-wrapper">
      <h1>Facilities</h1>
      <p>
        The campus of Techno India University is situated at  Kolkata the city of Joy providing fast connectivity to railway and airport situated at a distance less than 20 kilometers.
      </p>
