      ...
      <div className="gender-ratio-outer">
        <div className="gender-ratio-inner">
          ...
          <div className="gender-ratio-row" style={{marginBottom:'50px'}}>
            ...
            <p style={{fontSize:'18px'}}>
Techno India University, West Bengal, admitted a batch of B. Tech in Information Technology with an intake of 75 students 
w.e.f. the academic session 2019-20. Additionally, the university admitted a batch of B. Tech in Computer Science with an
 intake of 74 students w.e.f. the academic session 2019-20.
