...
const Messaget = props => (
    <div>
        ...
        <p className='msgp'>The Training and Placement cell of Techno India University, West Bengal is an integral part of the academics It helps in shaping the careers of our students in the field of Information Technology. </p><br />
        ...
        <br /><p className='cred' >Dr. Sudeep Chowdhury</p>
        <p className='cred' style={{ marginBottom: '2vw' }}>Training and Placement Officer, TIU West Bengal</p>
    </div>
)
